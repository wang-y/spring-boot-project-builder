...
import ${corepackage}.common.result.DefaultErrorResult;
import ${corepackage}.common.result.ParameterInvalidItem;
...
public class BaseGlobalExceptionHandler {
    ...
    protected DefaultErrorResult handleNoHandlerFoundException(NoHandlerFoundException e, HttpServletRequest request) {
        log.error("handleNoHandlerFoundException start, uri:{}, caused by: ", request.getRequestURI(), e);
         return DefaultErrorResult.failure(ResultCode.NOT_FOUND, e, HttpStatus.NOT_FOUND);
    }

    /**
     * METHOD_NOT_ALLOWED 暂时抓不到异常
     */
    protected DefaultErrorResult handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e, HttpServletRequest request) {
        log.error("handleHttpRequestMethodNotSupportedException start, uri:{}, caused by: ", request.getRequestURI(), e);
        return DefaultErrorResult.failure(ResultCode.METHOD_NOT_ALLOWED, e, HttpStatus.METHOD_NOT_ALLOWED);
    }
