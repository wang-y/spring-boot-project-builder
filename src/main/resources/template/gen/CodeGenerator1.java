...
public class CodeGenerator1 {
    ...
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://10.30.0.11:3306/testf";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "ori18502800930";
    ...
    public static String genModelAndVo(String tableName, String modelName) {
        ...
        try {
            ...
            con = DriverManager.getConnection(
                    "jdbc:mysql://10.30.0.11:3306/INFORMATION_SCHEMA?zeroDateTimeBehavior=convertToNull&autoReconnect=true&useUnicode=true&characterEncoding=utf-8",
                    "root", "ori18502800930");
            String sql = "select COLUMN_NAME,DATA_TYPE,COLUMN_COMMENT,COLUMN_KEY,EXTRA from COLUMNS where TABLE_SCHEMA='testf' and TABLE_NAME=?";
            ...
            String modelPackage = "com.wymix.demo.business.model";
            String voPackage = "com.wymix.demo.business.vo";
    ...
    private static String buildEntity(String[] colnames, String[] colTypes, String[] colKeys, String[] extras, String tableName, String modelname, boolean f_util, boolean f_sql) {
        ...
        sb.append("package com.wymix.demo.business.model;\r\n\r\n");
    ...
    private static String buildVo(String[] colnames, String[] colTypes, String[] colKeys, String[] extras, String tableName, boolean f_util) {
        StringBuffer sb = new StringBuffer();
        sb.append("package com.wymix.demo.business.vo;\r\n\r\n");
        sb.append("import java.io.Serializable;\r\n");
        // 判断是否导入工具包
        if (f_util) {
            sb.append("import java.util.Date;\r\n");
