...
public class SimplePage<T> implements Iterable<T>, Serializable {
	...
	private ${corepackage}.page.PageInfo pageInfo;
	...
	public SimplePage(${corepackage}.page.PageInfo pageInfo) {
	    this.pageInfo = pageInfo;
	    this.result = new ArrayList<T>();
	}

	public SimplePage(${corepackage}.page.PageInfo pageInfo, List<T> result) {
	    this.pageInfo = pageInfo;
	    this.result = result;
	}

	public ${corepackage}.page.PageInfo getPageInfo() {
	    return pageInfo;
	}

	public void setPageInfo(${corepackage}.page.PageInfo pageInfo) {
	    this.pageInfo = pageInfo;
	}
